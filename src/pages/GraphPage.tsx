...
export default function GraphPage() {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-gradient-to-br from-[#f3e8ff] via-[#e9e5ff] to-[#d8b4fe]">
      <div className="mx-auto h-full max-w-[1400px] p-6">
        <div className="grid h-full min-w-0 grid-cols-1 gap-4 lg:grid-cols-[260px_1fr]">
          {/* Left: schema browser */}
          <div className="pointer-events-auto z-10 hidden h-full w-[260px] rounded-xl border border-violet-200/60 bg-white/80 p-3 shadow-lg backdrop-blur lg:block">
          ...
          <div className="relative flex min-w-0 flex-col">
            ...
            <div className="relative flex-1 overflow-hidden">
              ...
              <div
                className={`pointer-events-auto absolute bottom-4 right-2 top-4 z-20 w-80 transform rounded-xl border border-violet-200/60 bg-white/85 p-3 shadow-lg backdrop-blur transition-transform duration-300 md:right-4 ${isStatsOpen ? 'translate-x-0' : 'translate-x-[calc(100%+1rem)]'}`}
                          ...
                          <>
                            ...
                            <div className="rounded-lg border bg-white p-2 text-xs text-zinc-600">
                              <p>
                                ...
                                NULLs or make columns NOT NULL where
                                appropriate.
                              </p>
                            </div>
                          </>
                        ...
                        <div className="max-h-[48vh] overflow-hidden rounded-lg border bg-white">
                          ...
                          <div className="max-h-[calc(48vh-40px)] overflow-y-auto">
                            <Accordion
                              ...
                              className="divide-y"
                            >
                              {(getTable(selectedId)?.columns || []).map(
                                (c) => {
                                  const m = getColumnMetrics(
                                    selectedId,
                                    c.name
                                  );
